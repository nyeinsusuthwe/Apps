package it.jgiem.apps.datecount;
...
import it.jgiem.apps.databinding.ActivityMainDatecounterBinding;
import it.jgiem.apps.databinding.DialogInputDatecounterBinding;
